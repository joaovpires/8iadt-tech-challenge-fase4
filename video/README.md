...
> **Notebook:** [`analise_pose.ipynb`](analise_pose.ipynb) — roda local (venv) ou no Colab; processa o vídeo com o MediaPipe Pose (não depende do Azure). Usa a **API Tasks** (`PoseLandmarker`) e baixa o modelo `pose_landmarker.task` automaticamente.
>
